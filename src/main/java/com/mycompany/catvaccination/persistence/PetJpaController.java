...
import com.mycompany.catvaccination.persistence.exceptions.NonexistentEntityException;
...
public class PetJpaController implements Serializable {
    ...
    public PetJpaController() {
        this.emf = Persistence.createEntityManagerFactory("CatVaccinationPU");
    }
